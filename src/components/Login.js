    ...
    return (
        <div>
            ...
            <div className="absolute">
                <img
                    className=" h-screen object-cover overflow-y-hidden md:h-auto "
                    src= {BG_URL}
                    alt="logo"
                />
            </div>
            <form
                ...
                className="absolute right-0 left-0 mx-auto my-60 w-10/12 p-12 bg-black text-white rounded-lg bg-opacity-80 md:w-3/12">
